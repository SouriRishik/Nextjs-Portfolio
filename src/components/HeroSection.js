  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-gradient-to-br from-white to-blue-50 pt-20">
      ...
      <div className="flex space-x-4">
        ...
        <a href="/SouriRishik_Resume.pdf" download className="border border-blue-600 text-blue-600 px-6 py-2 rounded-lg hover:bg-blue-50 transition">Download Resume</a>
      </div>
    </section>
  );
}
